...
namespace WPF_Game.Game
{
    public class FontInstaller
    {
        ...
        /// set to 'Copy Always'
        /// </summary>
        /// <param name="FilePath">Your font to be passed as a resource (i.e. "myfont.tff")</param>
        public static void RegisterFont(string FilePath)
        {
            ...
            var fontDestination = Path.Combine(System.Environment.GetFolderPath
                                              (System.Environment.SpecialFolder.Fonts), FilePath);

            if (!File.Exists(fontDestination))
            {
                // Copies font to destination
                System.IO.File.Copy(Path.Combine(System.IO.Directory.GetCurrentDirectory(), FilePath), fontDestination);
                ...
                actualFontName, FilePath, RegistryValueKind.String);
            }
        }
    }
}
